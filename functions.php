...
// — Add this to your functions.php file right above the scripts area
...
function travel_scripts() {
	...
	// ADDED
	wp_enqueue_script( 'travel-scripts', get_template_directory_uri() . '/js/scripts.js', array('jquery') );

	wp_enqueue_script( 'travel-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true );

	wp_enqueue_script( 'travel-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true );
...
function create_post_type() {
    register_post_type( 'travel_posts',
        array(
            'labels' => array(
